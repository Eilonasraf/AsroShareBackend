...
export async function uploadFile(file: Express.Multer.File): Promise<{ success: boolean; fileName?: string }> {
  ...
  const targetPath = path.join(__dirname, "../../../public", newFileName);
...
export async function replaceFile(file: Express.Multer.File, oldFilePath: string): Promise<{ success: boolean; fileName?: string }> {
